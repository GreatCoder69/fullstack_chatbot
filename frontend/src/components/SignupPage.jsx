        ...
        <div className="col-lg-4 mx-auto">
          ...
          >
            ...
            <form className="pt-3" onSubmit={handleSubmit}>
              ...
              {errorMessage && (
                <div className="mb-2 text-danger" style={{ fontWeight: 500, fontSize: 14 }}>
                  {errorMessage}
                </div>
              )}
              {successMessage && (
                <div className="mb-2 text-success" style={{ fontWeight: 500, fontSize: 14 }}>
                  {successMessage}
                </div>
              )}
              <div className="mt-3">
              ...
              >
                ...
                <Link
                  ...
                  style={{ color: '#a259ff', fontWeight: 500, textDecoration: 'none' }}
                >
                  Login
                </Link>
              </div>
